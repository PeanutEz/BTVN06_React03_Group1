...
export const orderClient = {
  getOrderByCartId: async (cartId: string): Promise<OrderDisplay | null> => {
    try {
      ...
      console.error(`[orderClient] getOrderByCartId(${cartId}) failed:`, error);
      return null;
    }
  },
  ...
  getOrdersByCustomerId: async (
    ...
    try {
      ...
      console.error(`[orderClient] getOrdersByCustomerId(${customerId}) failed:`, error);
      return [];
    }
  },
  ...
  getOrderByCode: async (orderCode: string): Promise<OrderDisplay | null> => {
    try {
      ...
      console.error(`[orderClient] getOrderByCode(${orderCode}) failed:`, error);
      return null;
    }
  },
  ...
  getOrderById: async (orderId: number | string): Promise<OrderDisplay | null> => {
    try {
      ...
      console.error(`[orderClient] getOrderById(${orderId}) failed:`, error);
      return null;
    }
  },
  ...
  getOrdersByFranchiseId: async (franchiseId: string): Promise<OrderDisplay[]> => {
    try {
      ...
      console.error(`[orderClient] getOrdersByFranchiseId(${franchiseId}) failed:`, error);
      return [];
    }
  },
  ...
  setPreparing: async (orderId: number | string): Promise<OrderDisplay | null> => {
    try {
      ...
      console.error(`[orderClient] setPreparing(${orderId}) failed:`, error);
      throw error; // Re-throw for mutations so UI can show error
    }
  },
  ...
  setReadyForPickup: async (
    ...
    try {
      ...
      console.error(`[orderClient] setReadyForPickup(${orderId}) failed:`, error);
      throw error; // Re-throw for mutations so UI can show error
    }
  },
};
