...
import type { Voucher, UpdateVoucherDto, CreateVoucherDto } from "@/models/voucher.model";
...
export function VoucherModal({ voucher, onClose, onSave }: VoucherModalProps) {
    ...
    try {
      ...
      if (voucher) {
        ...
        const createDto: CreateVoucherDto = {
          ...
          quota_total: formData.quota_total,
          start_date: payloadDateFormatted.start_date,
          end_date: payloadDateFormatted.end_date,
          franchise_id: formData.franchise_id,
          ...(formData.product_franchise_id
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="w-full max-w-xl rounded-2xl bg-white shadow-2xl flex flex-col max-h-[90vh] overflow-hidden">
        {/* Header */}
