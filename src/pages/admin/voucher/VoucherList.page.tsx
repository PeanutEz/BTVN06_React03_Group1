                      ...
                      <div className="flex items-center justify-center gap-2">
                        {isDeletedFilter ? (
                          ...
                          <>
                            ...
                            <button
                              title={v.is_active ? "Hủy kích hoạt" : "Kích hoạt"}
                              onClick={() => handleToggleStatus(v.id, v.is_active)}
                              className={`inline-flex size-8 items-center justify-center rounded-lg border transition-all shadow-sm hover:shadow ${
                                v.is_active
                            ...
                            >
                              {v.is_active ? (
                                <svg className="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" /></svg>
                              ) : (
