...
export default function CategoryFranchisePage() {
  ...
  }, [managerFranchiseId, routeFranchiseId]);

  const load = useCallback(async (page = 1, fid = franchiseId) => {
  ...
  }, [franchiseId, filterStatus, filterDeleted, searchQuery]);

  useEffect(() => { void load(1, franchiseId); }, [franchiseId, filterStatus, filterDeleted, load]);
