/* eslint-disable @typescript-eslint/no-explicit-any -- bản ghi ca / API */
...
export default function ShiftAssignmentPage() {
    ...
    const load = useCallback(
        ...
        [currentPage, searchNameApplied, filterFranchise, filterStatus, shiftMap],
    );
    ...
    useEffect(() => {
        ...
        void init();
        // Bootstrap một lần; filter/search đồng bộ qua state + effect filterFranchise
        // eslint-disable-next-line react-hooks/exhaustive-deps -- chỉ chạy mount, hasRun chặn lặp
    }, [load]);
    ...
    }, [managerFranchiseId, load, searchNameApplied, filterStatus]);
