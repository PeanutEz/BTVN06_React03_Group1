...
export default function PromotionPage() {
    ...
    const loadFranchises = async () => {
        try {
            ...
            /* bỏ qua: danh sách franchise không bắt buộc */
        }
    };
    ...
    const load = useCallback(
        ...
        [searchFranchise, currentPage, statusFilter, typeFilter, isDeletedFilter],
    );
    useEffect(() => {
    ...
    }, [searchFranchise, statusFilter, typeFilter, isDeletedFilter, load]);
